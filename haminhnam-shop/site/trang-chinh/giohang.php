                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="aa-header-bottom-area">
                            ...
                            <div class="aa-logo">
                                <!-- Text based logo -->
                                    <a href="http://localhost/haminhnam-shop/site/trang-chinh/" style="border: 3px solid black; border-radius: 10px ;padding: 2px 15px; cursor: pointer; font-weight: bold;">
                                            BigCityBoy
                            ...
                            <div class="aa-search-box">
                               <a href="http://localhost/haminhnam-shop/site/trang-chinh/" class="btn btn-info">QUAY VỀ TRANG CHỦ</a>
                                <?php ?>
                            </div>
                            <!-- / search box -->
                        </div>
                                ...
                                <div class="col-md-4 col-sm-6 ">
                                    <div class="aa-footer-widget">
                                        ...
                                        <ul class="aa-footer-nav">
                                            <li><a href="http://localhost/haminhnam-shop/site/trang-chinh/">
                                                    <font style="vertical-align: inherit;">
